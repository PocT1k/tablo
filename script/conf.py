...
# Айдентика
ICON_PANEL_PATH = IDENT_DIR / "grey.png"
ICON_WINS_PATH = IDENT_DIR / "trans.png"
ICON_TRY_PATH = IDENT_DIR / "trans.png"
IMAGE_BACK_PATH = IDENT_DIR / "back.png"
...
# Обовить pip
# python -m pip install --upgrade pip или python -m ensurepip --upgrade
# python --version
# pip --version
...
"""
Команда для сборки EXE через PyInstaller:

pyinstaller --noconfirm --specpath . --name "main" script/main.py
pyinstaller --onefile --windowed --icon=data/ident/trans.ico --name "atchuard" --add-data "$($pwd.Path)/.venv/Lib/site-packages/face_recognition_models/models/shape_predictor_68_face_landmarks.dat;face_recognition_models/models/shape_predictor_68_face_landmarks.dat" script/main.py
PyQt5
tensorflow
torch
"""
# docker build -t wgai .
# pyinstaller --onefile --windowed --icon=data\ident\trans.ico --name "" script\main.py

# tablo/
# │
# ├── script/                    # Все Python-скрипты
# │   ├── main.py                # Точка входа
